...
namespace EvolutionEngine
{
	...
	{
		this->m_splash = new Sprite(0, 0, IMG_SPLASHSCREEN, 1, 1, SWITCH_SCREEN_WIDTH, SWITCH_SCREEN_HEIGHT, 0, 0, false, false, 1, true);
		this->m_SFX = new SfxSound(SND_SFX_SPLASH, false, 2);
	}
