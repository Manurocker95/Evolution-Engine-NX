...
namespace EvolutionEngine
{
	...
	public:
		Sprite(int _x, int _y, char * _sprite, int _numFramesX, int _numFramesY, int _sizePerFrameX, int _sizePerFrameY, int _currentFrameX, int _currentFrameY, bool _multipleFrames, bool _animated, int _deltaTimeReduction = 1, bool _opacityMode = false, bool _draggable = false, int _ox = 0, int _oy = 0, bool _limitedInScreen = false);
		virtual ~Sprite();
		...
		virtual void LoadNewSprite(char * _img);
