...
namespace EvolutionEngine
{
	...
	public:
		SfxSound(char * _file, bool _inLoop, int _channel);
		~SfxSound();

		std::shared_ptr<Mix_Chunk> GetAudio();
		void SetAudio(std::shared_ptr<Mix_Chunk> _audio);
		void LoadAudio(char * _file) override;
